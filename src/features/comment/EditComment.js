...
import { Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, Divider, IconButton, Modal, Stack, Typography, alpha } from '@mui/material';
...
function EditComment({ comment, openEditDialog, editDialogClose, projectId }) {
  ...
  return (
    <Dialog open={openEditDialog} onClose={editDialogClose}>
      <DialogTitle color="primary" textAlign="center">Edit your comment <Divider /> </DialogTitle>
      <DialogContent>
